  ...
  return knex('starwars').del()
    .then(function () {
      return knex('starwars').insert([
        ...
        { id: 14, Title: 'The Book of Boba Fett', Released: '2021-29-12', ChronoDate: '3014-01-01', Period: '9 ABY',Image: 'starwars-book-of-boba-fett.jpg', Trailer: 'https://www.youtube-nocookie.com/embed/rOJ1cw6mohw' },
