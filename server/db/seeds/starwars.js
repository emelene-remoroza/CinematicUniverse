  ...
  return knex('starwars').del()
    .then(function () {
      return knex('starwars').insert([
        ...
        { id: 4, Title: 'Star Wars: Forces of Destiny', Released: '2017-07-03', ChronoDate: '3004-01-01', Period: '22-35 BBY', Image: 'starwars-forces-of-destiny.jpg', Trailer: 'https://www.youtube-nocookie.com/embed/2sJ67oyPH7o' },
