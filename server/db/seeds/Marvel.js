  ...
  return knex('Marvel').del()
    .then(function () {
      return knex('Marvel').insert([
        ...
        { id: 29, Title: 'The Falcon and the Winter Soldier', Released: '2021-02-19', ChronoDate: '2024-01-01', Image: 'the-falcon-and-the-winter-soldier-1.jpg', Trailer: 'https://www.youtube.com/watch?v=IWBsDaFWyTE' },
